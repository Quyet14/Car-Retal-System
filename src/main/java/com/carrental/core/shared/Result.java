package com.carrental.core.shared;
...
public class Result<T> {
    ...
    public static Result<Void> validationFailure(Error... errors) {
        return new Result<>(Arrays.asList(errors));
    }

    public static Result<Void> validationFailure(List<Error> errors) {
        return new Result<>(errors);
    }
